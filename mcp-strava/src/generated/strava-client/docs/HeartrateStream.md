...
**data** | **Array&lt;number&gt;** | The sequence of heart rate values for this stream, in beats per minute | [optional] [default to undefined]

## Example

```typescript
import { HeartrateStream } from './api';

const instance: HeartrateStream = {
    original_size,
    resolution,
    series_type,
    data,
