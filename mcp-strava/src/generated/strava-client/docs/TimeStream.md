...
**data** | **Array&lt;number&gt;** | The sequence of time values for this stream, in seconds | [optional] [default to undefined]

## Example

```typescript
import { TimeStream } from './api';

const instance: TimeStream = {
    original_size,
    resolution,
    series_type,
    data,
